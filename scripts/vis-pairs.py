...
class VisGraphics(object):
    ...
    def set_extent(self):
        ...
        print("[VisGraphics] extent: xmin %f  ymin %f  zmin %f" %
              (xmin, ymin, zmin))
        print("                      xmax %f  ymax %f  zmax %f" %
              (xmax, ymax, zmax))
    ...
    def render_strands(self):
        ...
        for id, base_list in strands.items():
            ...
            for base in base_list:
                self.render_sphere(
                    base.coord, self.dna_model.strand_colors[id])
                ...
                for base in base_list:
                    ...
                    if (paired_base_id != -1):
                        ...
                        if color1 not in pair_coords1:
                            pair_coords1[color1] = []
                        pair_coords1[color1].append(
                            (base.coord[0], base.coord[1], base.coord[2], x, y, z))
