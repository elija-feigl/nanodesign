...
def main():
    ...
    if args.helixdist:
        ...
        logger.info("Set the distance between adjacent helices to %g" %
    ...
    if args.outformat is None:
        ...
        logger.error("Unknown output file format given \'%s\'" %
                     args.outformat)
        error_flag = True
    else:
