...
class Lattice(object):
    ...
    @abstractmethod
    def get_neighbor_direction(self, row, col, nrow, ncol):
        """ Get the direction for a neighboring lattice coordinate. """
        raise NotImplementedError

    @abstractmethod
    def get_neighbor_index(self, row, col, nrow, ncol):
...
class SquareLattice(Lattice):
    """ This class defines the data and methods for a square lattice.
        ...
        Some of the data in this class is used to compute crossover positions between
        neighboring helices on a square lattice.
...
class HoneycombLattice(Lattice):
    """ This class defines the data and methods for a honeycomb lattice.
        ...
        Attributes:
            index_map_odd (List[Tuple()]): The list used to map lattice (row,col)
                coordinates into a neighbor index (0-2) for odd-numbered helices.
            index_map_even (List[Tuple()]): The list used to map lattice (row,col)
                coordinates into a neighbor index (0-2) for even-numbered helices.
            number_of_neighbors (int): The number of lattice cell neighbors.
            scaffold_low (List[List[Int]]): The list scaffold of crossover points.
            scaffold_high (List[List[Int]]): The list scaffold of crossover points.
            staple_low (List[List[Int]]): The list staple of crossover points.
