...
class Xform(object):
    ...
    def __init__(self, rotation_angles=None, translation=[0.0, 0.0, 0.0],
        ...
        """ Initialize a transformation.
            ...
            Arguments:
                rotation_angles (List[Float], optional): The list of three Euler angles in degrees used to create a
                    rotation matrix.
                translation (List[Float], optional): A list containing the x,y,z offsets for the translation.
                center (List[Float], optional): A list containing the x,y,z offsets for the center point for
                    any rotation.
                rotation_matrix (NumPy 3x3 ndarray[float], optional): A 3x3 rotation matrix, stored as a 3x3
                    numpy.ndarray.

            If you pass both a rotation_matrix paramater and a rotation_angles parameter, the rotation matrix
            will first be set, and then the rotation angles applied as if calling add_rotation.
        """
    ...
    def add_rotation(self, rotation_angles):
        """ Add a rotation matrix to the transformation.
            ...
            Arguments:
                rotation_angles (List[Float]): The list of three Euler angles in
                    degrees used to create a rotation matrix.
    ...
    def print_transformation(self):
        ...
        print("[xform] %8.2f %8.2f %8.2f" % (self.rotation_matrix[0, 0],
                                             self.rotation_matrix[0, 1], self.rotation_matrix[0, 2]))
        print("[xform] %8.2f %8.2f %8.2f" % (self.rotation_matrix[1, 0],
                                             self.rotation_matrix[1, 1], self.rotation_matrix[1, 2]))
        print("[xform] %8.2f %8.2f %8.2f" % (self.rotation_matrix[2, 0],
                                             self.rotation_matrix[2, 1], self.rotation_matrix[2, 2]))
        print("[xform] --------- translation ---------")
        print("[xform] %8.2f %8.2f %8.2f" %
