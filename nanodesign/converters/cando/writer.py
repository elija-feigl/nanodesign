...
class CandoWriter(object):
    ...
    def write(self, file_name):
        ...
        with open(file_name, 'w') as cndo_file:
            # write header
            cndo_file.write(
                '"CanDo (.cndo) file format version 1.0, Keyao Pan, Laboratory for Computational \
                    Biology and Biophysics, Massachusetts Institute of Technology, November 2015"\n')
            cndo_file.write("\n")
            ...
            for i in range(0, len(base_conn)):
                ...
                cndo_file.write(
                    "%d,%f,%f,%f,%f,%f,%f,%f,%f,%f\n" % (
                        i+1, -ref_frame[0, 0], -
                        ref_frame[1, 0], -ref_frame[2, 0],
                        ref_frame[0, 1], ref_frame[1, 1],
                        ref_frame[2, 1], -ref_frame[0, 2],
                        -ref_frame[1, 2], -ref_frame[2, 2]
                    )
                )
            cndo_file.write("\n")
