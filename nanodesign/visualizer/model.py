...
class VisModel(object):
    ...
    def _create_helices(self):
        ...
        helix_list = sorted(
            list(dna_structure.structure_helices_map.values()), key=lambda x: x.lattice_num)
    ...
    def _set_extent(self):
        ...
        self._logger.info("Extent  xmin %f  ymin %f  zmin %f" %
                          (xmin, ymin, zmin))
        self._logger.info("        xmax %f  ymax %f  zmax %f" %
                          (xmax, ymax, zmax))
